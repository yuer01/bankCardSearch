	...
	class Program
	{
	 ...
	 "上海浦东发展银行.东方卡", "深圳发展银行.发展卡", };
		static void Main(string[] args)
		{
			...
			if (cardno.Length < 6) return;
			var head = cardno.Substring(0, 6);
			for (int i = 0; i < CardNoHead.Length; i++)
			{
				if (CardNoHead[i].ToString() == head)
				{ Console.WriteLine(CardName[i]); break; }
			}
